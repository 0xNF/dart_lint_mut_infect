...
// Shouldn't be marked, because it is `main`
void main() {
  globalScopeVar = 3;
}
...
// Shouldn't me marked, because it is `@override`
  @override
  void doSomeThing() {
    globalScopeVar = 3;
  }
...
// This should not be marked for any errors because it modifies nothing and calls no mut functions
...
// Should not be marked for errors because its marked mut
// expect_lint: unnecessary_mut_infect
void isMarkedMut() {}

//  Should be marked for Mut because it mutates an out of scope
// expect_lint: mut_out_of_scope
...
// Should NOT be marked for errors because the variable is entirely within the function scope
void mutsInnerScope() {
  int i = 0;
  void inner() {
    i = 2;
...
// should be marked Mut for modifying outer scope
void mutsOuterScope() {
  int i = -1;
